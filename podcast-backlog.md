...
1. 🤖 **Zero Trust for AI Agents — Anthropic's Security Framework**
   - Category: AI
   - Source: https://cdn.prod.website-fields.com/6889473510b50328dbb70ae6/6a1611a04085d7cd3dadc924_Claude-eBook-Zero-Trust-for-AI-Agents-05182026.pdf
   - Type: Topic/research-based
   - Flags: `--long` (~10 min)
   - Notes: Anthropic's official ebook (May 2026) on enterprise security for autonomous AI agents. 7-layer control plane, Agentic SOAR, compliance mapping. Moves from "Never Trust" to "Bounded Trust." Covers: dynamic authorization, OAuth limitations for agents, multi-cloud deployment (AWS Bedrock, Azure, Vertex). Connects to Robinhood ep110 (agents with financial access), ep99 (agent terminal death), and ep111 (build a system that prompts itself). Señora Freedom angle: who controls the trust boundaries when agents act autonomously?

2. 🤖 **OpenHands — Open Source AI Software Engineer**
   - Source: https://github.com/OpenHands/OpenHands
   - Type: Topic/research-based
   - Flags: `--long` (~10 min)
   - Notes: Deep dive into the open-source autonomous coding agent

3. 🏛️ **Liberland 2026 Master Plan**
