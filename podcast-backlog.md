...
2. 🏛️ **The History of Taxation: From Ancient Tribute to Modern Certainty** *(producing now)*
   - Type: Topic/research-based
   - Flags: `--long` (~10 min)
...
4. 🤖 **AI Made Us Faster. That Was the Problem** — David Fowler (Aspire/.NET)
   - Category: AI
...
5. 🎥 **X/Twitter video — @trq212**
   - Source: https://x.com/trq212/status/2044548257058328723
   - Type: URL-based
   - Flags: default (~5 min)

6. *(gap — 4 non-Liberland before next Liberland)*

7. 🏛️ **Liberland 2026 Master Plan**
