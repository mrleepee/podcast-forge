...
- ep99 — Your AI Agent Dies the Second You Close the Terminal (X/Twitter video — David Ondrej tmux)
- ep101 — GBrain: Garry Tan's AI Knowledge System That Makes You Wake Up Smarter
...
2. **Uganda Real Estate Investment for Foreigners**
...
3. **The History of Taxation: From Ancient Tribute to Modern Certainty**
   - Type: Topic/research-based
   - Flags: `--long` (~10 min)
...
4. **X/Twitter video (non-English — needs translation)**
...
5. **Anthropic Blog: The Unreasonable Effectiveness of HTML for AI Agents**
...
7. *(need 4 non-Liberland episodes before next)*

8. **Robinhood Is Now Open to Agents**
